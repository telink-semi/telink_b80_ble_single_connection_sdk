...
#define	SOFT_UART_INTERVAL				 (sys_tick_per_us*1000*1000/SOFT_UART_BAUD_RATE)
#endif
...
#ifdef SOFT_UART_TX_IO
#define TX_UART_GPIO_EN()				  gpio_set_func(SOFT_UART_TX_IO , AS_GPIO);
#define TX_UART_PULLUP_1M()			      gpio_setup_up_down_resistor(SOFT_UART_TX_IO, PM_PIN_PULLUP_1M);
#define TX_UART_OUTPUT_EN()				  gpio_set_output_en(SOFT_UART_TX_IO,1)
#define TX_UART_OUTPUT_REG				  (0x503+((SOFT_UART_TX_IO>>8)<<3))
#endif
