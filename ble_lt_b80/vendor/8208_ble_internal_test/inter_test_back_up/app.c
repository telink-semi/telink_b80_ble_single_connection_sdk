...
/*----------------------------------------------------------------------------*/
#if(RC_BTN_ENABLE)
#define MAX_BTN_SIZE			6
#define BTN_VALID_LEVEL			0

#define USER_BTN_1				0x01
#define USER_BTN_2				0x02
#define USER_BTN_3				0x03
#define USER_BTN_4				0x04
#define USER_BTN_5				0x05
#define USER_BTN_6				0x06

u32 ctrl_btn[] = {SW1_GPIO, SW2_GPIO, SW3_GPIO, SW4_GPIO, SW5_GPIO, SW6_GPIO};
u8 btn_map[MAX_BTN_SIZE] = {USER_BTN_1, USER_BTN_2, USER_BTN_3, USER_BTN_4 ,USER_BTN_5, USER_BTN_6};
